...
TDateTime startDate;  // Начальная дата
	TDateTime endDate;    // Конечная дата

public:	  	// User declarations
	__fastcall TForm2(TComponent* Owner);
	void __fastcall SetDateRange(TDateTime start, TDateTime end);  // Установка диапазона дат
    void __fastcall FilterItemsByDate();  // Фильтрация товаров по датам
